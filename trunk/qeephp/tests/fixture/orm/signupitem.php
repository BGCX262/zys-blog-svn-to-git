<?php
// $Id: signupitem.php 11 2012-02-08 06:05:02Z zys4416@gmail.com $

/**
 * SignUpItem 封装来自 signup_items 数据表的记录及领域逻辑
 */
class SignUpItem extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'signup_id' => array
                (
                    array('is_int', '报名ID必须是一个整数'),

                ),

                'ticket_id' => array
                (
                    array('is_int', '入场卷ID必须是一个整数'),
