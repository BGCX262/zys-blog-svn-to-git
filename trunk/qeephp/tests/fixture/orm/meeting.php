<?php
// $Id: meeting.php 11 2012-02-08 06:05:02Z zys4416@gmail.com $

/**
 * Meeting 封装一个会议的数据和行为
 */
class Meeting extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                'organizer' => array(
                    QDB::BELONGS_TO => 'Organize', 
                    'source_key'    => 'organizer_id', 
                    'target_key'    => 'id',
                ),

                'ticket_types' => array(
                    QDB::HAS_MANY   => 'TicketType',
                    'source_key'    => 'id',
                    'target_key'    => 'meeting_id',
                ),
            ...
            (
                'subject' => array
                (
                    array('not_empty', '主题不能为空'),
                    array('max_length', 200, '主题不能超过 200 个字符'),

                ),

                'overview' => array
                (
                    array('not_empty', '概述不能为空'),

                ),

                'organizer_id' => array
                (
                    array('is_int', '组织者ID必须是一个整数'),

                ),

                'published_at' => array
                (
                    array('is_int', '发布时间必须是一个整数'),
