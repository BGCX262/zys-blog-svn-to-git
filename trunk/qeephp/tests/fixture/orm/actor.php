<?php
// $Id: actor.php 11 2012-02-08 06:05:02Z zys4416@gmail.com $

/**
 * Actor 封装来自 actors 数据表的记录及领域逻辑
 */
class Actor extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'realname' => array
                (
                    array('not_empty', '真实姓名不能为空'),
                    array('max_length', 30, '真实姓名不能超过 30 个字符'),
                ...
                (
                    ...
                    array('max_length', 200, '地址不能超过 200 个字符'),
