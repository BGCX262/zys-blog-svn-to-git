<?php
// $Id: tickettype.php 11 2012-02-08 06:05:02Z zys4416@gmail.com $

/**
 * TicketType 封装来自 ticket_types 数据表的记录及领域逻辑
 */
class TicketType extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                // 主键应该是只读，确保领域对象的“不变量”
                'meeting_id' => array('readonly' => true),
             ...
             */
            'attr_protected' => 'meeting_id, name',
            ...
            (
                'ticket_price' => array
                (
                    array('is_float', '入场卷价格必须是一个浮点数'),

                ),

                'ticket_quantity' => array
                (
                    array('is_int', '入场卷数量必须是一个整数'),
